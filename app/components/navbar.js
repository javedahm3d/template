...
export default function Navbar({setNavbarvalue=false}){
  ...
  React.useEffect(() => {
    ...
    return(
      ...
      <nav className={navbar? 'bg-white drop-shadow-md xl:block hidden w-screen fixed top-0 z-50': 'drop-shadow-md xl:block hidden w-screen fixed top-0 z-50'}>
                          ...
                          <div className="visible xl:hidden">
                              <ul className="p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
                                  ...
                                  <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                      <div className="flex items-center">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user" width={50} height={30} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                              <path stroke="none" d="M0 0h24v24H0z" />
      ...
      <nav>
          ...
          <div className={show ? "w-full xl:hidden h-full z-40  transform  translate-x-0 fixed top-0 left-0" : "   w-full xl:hidden h-full absolute z-40  transform -translate-x-full"}>
                  ...
                  <div className="px-6 h-full">
                      <div className="flex flex-col justify-between h-full w-full">
                          <div>
                              ...
                              <ul className="f-m-m">
                                <Link href="#ethicssection" className="cursor-pointer" onClick={() => setShow(!show)} >
                                ...
                                <Link href="#ourservicessection" className="cursor-pointer" onClick={() => setShow(!show)} >
                                      <li className="text-gray-800 pt-8">
                                          <div className="flex items-center justify-between">
                                              <div className="flex items-center">
                                                  ...
                                                  <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Services</p>
                                              </div>
                                          </div>
                                      </li>
                                 </Link>
                                 <Link href="#project" className="cursor-pointer" onClick={() => setShow(!show)} >
                                      <li className="text-gray-800 pt-8">
                                          <div className="flex items-center">
                                              <div className="w-6 h-6 md:w-8 md:h-8 text-gray-800">
                                              ...
                                              <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Projects</p>
                                          </div>
                                      </li>
                                 </Link>
                                  <li className="text-gray-800 pt-8 cursor-pointer" onClick={() => document.getElementById("my_modal_2").showModal()}>
                                      <div className="flex items-center justify-between">
                                          <div className="flex items-center">
                                              <div className="w-6 h-6 md:w-8 md:h-8 text-gray-800">
                                              ...
                                              <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Contact Us</p>
                                          </div>
                                      </div>
                                  </li>
                              </ul>
